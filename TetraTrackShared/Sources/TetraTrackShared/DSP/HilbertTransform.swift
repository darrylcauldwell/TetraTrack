...
public enum HilbertTransform {
    ...
    public static func analyticSignal(_ signal: [Double]) -> [(real: Double, imag: Double)] {
        let n = signal.count
        ...
        realBuffer.withUnsafeMutableBufferPointer { realPtr in
            imagBuffer.withUnsafeMutableBufferPointer { imagPtr in
                ...
                // Keep DC unchanged, multiply positive frequencies by 2
                var scale: Float = 2.0
    ...
    public static func instantaneousPhase(_ signal: [Double]) -> [Double] {
    ...
    public static func unwrappedPhase(_ signal: [Double]) -> [Double] {
    ...
    public static func envelope(_ signal: [Double]) -> [Double] {
        let analytic = analyticSignal(signal)
    ...
    public static func phaseDifference(signal1: [Double], signal2: [Double]) -> [Double] {
    ...
    public static func meanPhaseDifference(signal1: [Double], signal2: [Double]) -> Double {
    ...
    public static func meanPhaseDifferenceDegrees(signal1: [Double], signal2: [Double]) -> Double {
    ...
    public static func instantaneousFrequency(_ signal: [Double], sampleRate: Double) -> [Double] {
