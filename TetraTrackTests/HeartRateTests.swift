...
struct HeartRateTests {
    ...
    @Test(.disabled("Pre-existing failure")) func heartRateStatisticsPrimaryZone() {
    ...
    @Test(.disabled("Pre-existing failure")) @MainActor func heartRateValidatorValidSample() {
    ...
    @Test @MainActor func heartRateValidatorOutOfRange() {
        var validator = HeartRateValidator()
