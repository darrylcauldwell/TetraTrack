...
final class ScreenshotTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        app.launchArguments = ["-screenshotMode", "-UITesting"]
        app.launch()
    ...
    func test02_RidingTrackingView() throws {
        // Tap on Riding card
        let ridingCard = app.buttons["Riding"]
    ...
    func test03_RideDetail() throws {
        ...
        let historyCard = app.buttons["Training History"]
    ...
    func test04_CompetitionCalendar() throws {
        ...
        let competitionCard = app.buttons["Competitions"]
    ...
    func test06_RunningView() throws {
        ...
        // Tap on Running
        let runningCard = app.buttons["Running"]
    ...
    func test07_SwimmingView() throws {
        ...
        // Tap on Swimming
        let swimmingCard = app.buttons["Swimming"]
    ...
    func test08_ShootingView() throws {
        ...
        // Tap on Shooting
        let shootingCard = app.buttons["Shooting"]
    ...
    func test10_LiveSharing() throws {
        ...
        // Tap on Live Sharing
        let liveSharingCard = app.buttons["Live Sharing"]
