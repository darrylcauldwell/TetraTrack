...
struct RidingArtifactData: Codable, Sendable {
    ...
    private enum CodingKeys: String, CodingKey {
        case gaitDurations, leftLeadDuration, rightLeadDuration
        case averageSpeed, maxSpeed, elevationGain
        case turnCount, horseName
    }
    ...
    nonisolated init(from decoder: Decoder) throws {
        ...
        self.gaitDurations = try container.decode([String: TimeInterval].self, forKey: .gaitDurations)
        self.leftLeadDuration = try container.decodeIfPresent(TimeInterval.self, forKey: .leftLeadDuration)
        self.rightLeadDuration = try container.decodeIfPresent(TimeInterval.self, forKey: .rightLeadDuration)
        ...
        self.horseName = try container.decodeIfPresent(String.self, forKey: .horseName)
    }

    nonisolated func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: CodingKeys.self)
        try container.encode(gaitDurations, forKey: .gaitDurations)
        try container.encodeIfPresent(leftLeadDuration, forKey: .leftLeadDuration)
        try container.encodeIfPresent(rightLeadDuration, forKey: .rightLeadDuration)
        ...
        try container.encodeIfPresent(horseName, forKey: .horseName)
    }
}

/// Running-specific artifact data
struct RunningArtifactData: Codable, Sendable {
    ...
    private enum CodingKeys: String, CodingKey {
        case averagePace, averageCadence, elevationGain
        case splits, runMode
    }
    ...
    nonisolated init(from decoder: Decoder) throws {
        ...
        self.averageCadence = try container.decode(Int.self, forKey: .averageCadence)
        self.elevationGain = try container.decode(Double.self, forKey: .elevationGain)
        self.splits = try container.decode([SplitSummary].self, forKey: .splits)
        self.runMode = try container.decode(String.self, forKey: .runMode)
    }
...
struct SplitSummary: Codable, Identifiable, Sendable {
    var id: UUID = UUID()
    ...
    private enum CodingKeys: String, CodingKey {
        case id, distance, duration, pace
    }
    ...
    nonisolated init(from decoder: Decoder) throws {
        ...
        self.pace = try container.decode(TimeInterval.self, forKey: .pace)
    }
...
struct SwimmingArtifactData: Codable, Sendable {
    ...
    private enum CodingKeys: String, CodingKey {
        case averagePace, averageSwolf, totalStrokes
        case lapCount, dominantStroke, poolLength
    }
    ...
    nonisolated init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.averagePace = try container.decode(TimeInterval.self, forKey: .averagePace)
        self.averageSwolf = try container.decode(Double.self, forKey: .averageSwolf)
        self.totalStrokes = try container.decode(Int.self, forKey: .totalStrokes)
        self.lapCount = try container.decode(Int.self, forKey: .lapCount)
        self.dominantStroke = try container.decode(String.self, forKey: .dominantStroke)
        self.poolLength = try container.decodeIfPresent(Double.self, forKey: .poolLength)
    }

    nonisolated func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: CodingKeys.self)
        try container.encode(averagePace, forKey: .averagePace)
        try container.encode(averageSwolf, forKey: .averageSwolf)
        try container.encode(totalStrokes, forKey: .totalStrokes)
        try container.encode(lapCount, forKey: .lapCount)
        try container.encode(dominantStroke, forKey: .dominantStroke)
        try container.encodeIfPresent(poolLength, forKey: .poolLength)
    }
}

/// Shooting-specific artifact data
struct ShootingArtifactData: Codable, Sendable {
    var totalScore: Int
    ...
    private enum CodingKeys: String, CodingKey {
        case totalScore, maxPossibleScore, shotCount
        case averageScore, groupRadius, shootingSessionType
    }
    ...
    nonisolated init(from decoder: Decoder) throws {
        ...
        self.maxPossibleScore = try container.decode(Int.self, forKey: .maxPossibleScore)
        self.shotCount = try container.decode(Int.self, forKey: .shotCount)
        self.averageScore = try container.decode(Double.self, forKey: .averageScore)
        self.groupRadius = try container.decodeIfPresent(Double.self, forKey: .groupRadius)
        self.shootingSessionType = try container.decode(String.self, forKey: .shootingSessionType)
    }

    nonisolated func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: CodingKeys.self)
        try container.encode(totalScore, forKey: .totalScore)
        try container.encode(maxPossibleScore, forKey: .maxPossibleScore)
        try container.encode(shotCount, forKey: .shotCount)
        try container.encode(averageScore, forKey: .averageScore)
        try container.encodeIfPresent(groupRadius, forKey: .groupRadius)
        try container.encode(shootingSessionType, forKey: .shootingSessionType)
    }
}
