...
struct CompetitionResults: Codable, Sendable {
    ...
    private enum CodingKeys: String, CodingKey {
        case overallPlacing, shootingScore, shootingPoints
        case swimmingTime, swimmingPoints
        case runningTime, runningPoints
        case ridingScore, ridingPoints
        case totalPoints
    }
    ...
    nonisolated init(from decoder: Decoder) throws {
        ...
        self.overallPlacing = try container.decodeIfPresent(Int.self, forKey: .overallPlacing)
        self.shootingScore = try container.decodeIfPresent(Int.self, forKey: .shootingScore)
        self.shootingPoints = try container.decodeIfPresent(Int.self, forKey: .shootingPoints)
        self.swimmingTime = try container.decodeIfPresent(TimeInterval.self, forKey: .swimmingTime)
        self.swimmingPoints = try container.decodeIfPresent(Int.self, forKey: .swimmingPoints)
        self.runningTime = try container.decodeIfPresent(TimeInterval.self, forKey: .runningTime)
        self.runningPoints = try container.decodeIfPresent(Int.self, forKey: .runningPoints)
        self.ridingScore = try container.decodeIfPresent(Double.self, forKey: .ridingScore)
        self.ridingPoints = try container.decodeIfPresent(Int.self, forKey: .ridingPoints)
        self.totalPoints = try container.decodeIfPresent(Int.self, forKey: .totalPoints)
    }

    nonisolated func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: CodingKeys.self)
        try container.encodeIfPresent(overallPlacing, forKey: .overallPlacing)
        try container.encodeIfPresent(shootingScore, forKey: .shootingScore)
        try container.encodeIfPresent(shootingPoints, forKey: .shootingPoints)
        try container.encodeIfPresent(swimmingTime, forKey: .swimmingTime)
        try container.encodeIfPresent(swimmingPoints, forKey: .swimmingPoints)
        try container.encodeIfPresent(runningTime, forKey: .runningTime)
        try container.encodeIfPresent(runningPoints, forKey: .runningPoints)
        try container.encodeIfPresent(ridingScore, forKey: .ridingScore)
        try container.encodeIfPresent(ridingPoints, forKey: .ridingPoints)
