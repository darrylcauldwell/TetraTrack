...
nonisolated struct NormalizedTargetPosition: Codable, Equatable, Hashable {
    ...
    nonisolated var radialDistance: Double {
        sqrt(x * x + y * y)
    }

    /// Elliptical distance accounting for oval targets
    /// - Parameter aspectRatio: width/height ratio of target
    nonisolated func ellipticalDistance(aspectRatio: Double) -> Double {
    ...
    nonisolated var angleDegrees: Double {
        atan2(y, x) * 180 / .pi
    }

    /// Angle from center in radians
    nonisolated var angleRadians: Double {
        atan2(y, x)
    }

    /// Distance to another position
    nonisolated func distance(to other: NormalizedTargetPosition) -> Double {
        let dx = x - other.x
        let dy = y - other.y
    ...
    nonisolated func toMillimeters(targetRadiusMM: CGSize) -> CGPoint {
        CGPoint(
...
/// at the midpoint.
struct TargetCropGeometry: Codable, Equatable, Sendable {
    ...
    private enum CodingKeys: String, CodingKey {
        case cropRect, targetSemiAxes, rotationDegrees
        case axesSwapped, physicalAspectRatio, boundaryType
    }
    ...
    nonisolated var targetCenterInCrop: CGPoint {
    ...
    nonisolated init(from decoder: Decoder) throws {
        ...
        self.cropRect = try container.decode(CGRect.self, forKey: .cropRect)
        self.targetSemiAxes = try container.decode(CGSize.self, forKey: .targetSemiAxes)
        self.rotationDegrees = try container.decodeIfPresent(Double.self, forKey: .rotationDegrees) ?? 0
        self.axesSwapped = try container.decodeIfPresent(Bool.self, forKey: .axesSwapped) ?? false
        self.physicalAspectRatio = try container.decode(Double.self, forKey: .physicalAspectRatio)
        self.boundaryType = try container.decode(BoundaryType.self, forKey: .boundaryType)
    }

    nonisolated func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: CodingKeys.self)
        try container.encode(cropRect, forKey: .cropRect)
        try container.encode(targetSemiAxes, forKey: .targetSemiAxes)
        try container.encode(rotationDegrees, forKey: .rotationDegrees)
        try container.encode(axesSwapped, forKey: .axesSwapped)
        try container.encode(physicalAspectRatio, forKey: .physicalAspectRatio)
...
struct TargetAlignment: Codable, Equatable, Sendable {
    ...
    private enum CodingKeys: String, CodingKey {
        case confirmedCenter, confirmedSemiAxes, centerOffset
        case rotationAdjustment, alignmentConfidence
        case wasManuallyAdjusted, confirmedAt
    }

    nonisolated init(
        confirmedCenter: CGPoint,
        confirmedSemiAxes: CGSize,
        centerOffset: CGPoint = .zero,
        rotationAdjustment: Double = 0,
        alignmentConfidence: Double = 1.0,
        wasManuallyAdjusted: Bool = false,
        confirmedAt: Date = Date()
    ) {
        self.confirmedCenter = confirmedCenter
        self.confirmedSemiAxes = confirmedSemiAxes
    ...
    nonisolated init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.confirmedCenter = try container.decode(CGPoint.self, forKey: .confirmedCenter)
        self.confirmedSemiAxes = try container.decode(CGSize.self, forKey: .confirmedSemiAxes)
        self.centerOffset = try container.decodeIfPresent(CGPoint.self, forKey: .centerOffset) ?? .zero
        self.rotationAdjustment = try container.decodeIfPresent(Double.self, forKey: .rotationAdjustment) ?? 0
        self.alignmentConfidence = try container.decodeIfPresent(Double.self, forKey: .alignmentConfidence) ?? 1.0
        self.wasManuallyAdjusted = try container.decodeIfPresent(Bool.self, forKey: .wasManuallyAdjusted) ?? false
        self.confirmedAt = try container.decodeIfPresent(Date.self, forKey: .confirmedAt) ?? Date()
    }

    nonisolated func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: CodingKeys.self)
        try container.encode(confirmedCenter, forKey: .confirmedCenter)
        try container.encode(confirmedSemiAxes, forKey: .confirmedSemiAxes)
        try container.encode(centerOffset, forKey: .centerOffset)
        try container.encode(rotationAdjustment, forKey: .rotationAdjustment)
        try container.encode(alignmentConfidence, forKey: .alignmentConfidence)
        try container.encode(wasManuallyAdjusted, forKey: .wasManuallyAdjusted)
    ...
    nonisolated static func autoCalculated(semiAxes: CGSize = CGSize(width: 0.4, height: 0.45)) -> TargetAlignment {
        TargetAlignment(
...
struct AcquisitionQuality: Codable, Equatable, Sendable {
    ...
    private enum CodingKeys: String, CodingKey {
        case imageSharpness, imageContrast, exposureLevel
        case centerConfidence, perspectiveSeverity
        case detectionAutoAcceptRate
    }

    nonisolated init(
        imageSharpness: Double,
        imageContrast: Double,
        exposureLevel: ExposureLevel,
        centerConfidence: Double,
        perspectiveSeverity: Double,
        detectionAutoAcceptRate: Double = 0
    ) {
        self.imageSharpness = imageSharpness
        self.imageContrast = imageContrast
        self.exposureLevel = exposureLevel
        self.centerConfidence = centerConfidence
        self.perspectiveSeverity = perspectiveSeverity
        self.detectionAutoAcceptRate = detectionAutoAcceptRate
    }

    nonisolated init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.imageSharpness = try container.decode(Double.self, forKey: .imageSharpness)
        self.imageContrast = try container.decode(Double.self, forKey: .imageContrast)
        self.exposureLevel = try container.decode(ExposureLevel.self, forKey: .exposureLevel)
        self.centerConfidence = try container.decode(Double.self, forKey: .centerConfidence)
        self.perspectiveSeverity = try container.decode(Double.self, forKey: .perspectiveSeverity)
        self.detectionAutoAcceptRate = try container.decodeIfPresent(Double.self, forKey: .detectionAutoAcceptRate) ?? 0
    }

    nonisolated func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: CodingKeys.self)
        try container.encode(imageSharpness, forKey: .imageSharpness)
        try container.encode(imageContrast, forKey: .imageContrast)
        try container.encode(exposureLevel, forKey: .exposureLevel)
        try container.encode(centerConfidence, forKey: .centerConfidence)
        try container.encode(perspectiveSeverity, forKey: .perspectiveSeverity)
        try container.encode(detectionAutoAcceptRate, forKey: .detectionAutoAcceptRate)
    }
...
struct TargetCoordinateTransformer: Sendable {
    ...
    nonisolated func toTargetCoordinates(pixelPosition: CGPoint) -> NormalizedTargetPosition {
    ...
    nonisolated func toPixelPosition(targetPosition: NormalizedTargetPosition) -> CGPoint {
        let semiAxes = cropGeometry.axesSwapped
            ? CGSize(width: cropGeometry.targetSemiAxes.height, height: cropGeometry.targetSemiAxes.width)
            : cropGeometry.targetSemiAxes
    ...
    nonisolated func toPixelRadius(_ normalizedRadius: Double) -> CGFloat {
    ...
    nonisolated func toNormalizedRadius(_ pixelRadius: CGFloat) -> Double {
        let avgSemiAxis = (cropGeometry.targetSemiAxes.width + cropGeometry.targetSemiAxes.height) / 2
        let avgImageSize = (imageSize.width + imageSize.height) / 2
...
struct HoleSizeCalibration: Codable, Equatable {
    ...
    nonisolated func expectedDiameterRange(transformer: TargetCoordinateTransformer, tolerance: Double = 0.5) -> ClosedRange<CGFloat> {
