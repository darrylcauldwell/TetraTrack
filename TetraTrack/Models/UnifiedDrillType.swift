...
enum UnifiedDrillType: String, CaseIterable, Codable, Identifiable {
    ...
    // MARK: - Walking Drills (3)
    case walkingMetronome = "Walking Metronome"
    case walkingSymmetryFocus = "Walking Symmetry Focus"
    case walkingPosture = "Walking Posture"
    ...
    var benefitsDisciplines: Set<TrainingDiscipline> {
        ...
        // Walking drills benefit running
        case .walkingMetronome, .walkingSymmetryFocus, .walkingPosture:
            return [.running]
    ...
    var primaryCategory: MovementCategory {
        ...
        // Rhythm
        case .postingRhythm, .cadenceTraining, .kickEfficiency, .walkingMetronome:
            return .rhythm
    ...
    var icon: String {
        ...
        // Walking
        case .walkingMetronome: return "metronome"
        case .walkingSymmetryFocus: return "figure.walk"
        case .walkingPosture: return "figure.stand"
    ...
    var description: String {
        ...
        // Walking
        case .walkingMetronome:
            return "Walk at a target cadence of 120 SPM to develop consistent stepping rhythm."
        case .walkingSymmetryFocus:
            return "Focus on even left/right loading during walking to improve gait symmetry."
        case .walkingPosture:
            return "Practice upright posture cues while walking - head tall, shoulders relaxed, core engaged."
