...
nonisolated struct StadiumGeometry {
    ...
    nonisolated var totalWidth: Double { semicircleRadius * 2 }

    /// Total height of the stadium
    nonisolated var totalHeight: Double { straightHeight + (semicircleRadius * 2) }
    ...
    nonisolated func normalizedDistance(from point: CGPoint) -> Double {
...
nonisolated struct TetrathlonTargetGeometry {
    ...
    nonisolated static let aspectRatio: Double = 0.77
    ...
    nonisolated static let straightToRadiusRatio: Double = 0.6
    ...
    nonisolated static let normalizedScoringRadii: [(score: Int, normalizedRadius: Double)] = [
    ...
    nonisolated static func stadiumGeometry(forNormalizedRadius normalizedRadius: Double) -> StadiumGeometry {
    ...
    nonisolated static func score(from position: NormalizedTargetPosition) -> Int {
...
nonisolated struct OlympicPistolTargetGeometry {
    ...
    nonisolated static let scoringRings: [(score: Int, diameter: Double)] = [
    ...
    nonisolated static let aspectRatio: Double = 1.0
...
nonisolated enum ShootingTargetGeometryType: String, Codable, CaseIterable {
    ...
    nonisolated func score(from position: NormalizedTargetPosition) -> Int {
        switch self {
        case .tetrathlon:
    ...
    nonisolated var normalizedScoringRadii: [(score: Int, radius: Double)] {
        switch self {
        case .tetrathlon:
