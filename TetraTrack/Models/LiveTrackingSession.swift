...
final class LiveTrackingSession {
    ...
    var isRunningSession: Bool { activityType == "running" }

    var activityLabel: String {
        if isRunningSession {
            switch currentGait {
            case GaitType.walk.rawValue: return "Walking"
            case GaitType.trot.rawValue: return "Jogging"
            case GaitType.canter.rawValue: return "Running"
            case GaitType.gallop.rawValue: return "Sprinting"
    ...
    var activityIcon: String {
        isRunningSession ? "figure.run" : "figure.equestrian.sports"
    }
