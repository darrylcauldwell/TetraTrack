...
final class ShootingSession: TrainingSessionProtocol, SessionWritable {
    ...
    // Heart rate data (from HealthKit post-session)
    ...
    var averageHoldDuration: Double = 0
    var shotTimingConsistencyCV: Double = 0
...
final class Shot {
    ...
    // Watch sensor data (per-shot)
    var holdSteadiness: Double = 0       // 0-100
    var holdDuration: Double = 0          // seconds
    var raiseSmoothness: Double = 0       // 0-100
    var settleDuration: Double = 0        // seconds
    var tremorIntensity: Double = 0       // 0-100
    var driftMagnitude: Double = 0        // 0-100
    var totalCycleTime: Double = 0        // seconds
    var heartRateAtShot: Int = 0          // bpm
    var holdPitchVariance: Double = 0
    var holdYawVariance: Double = 0
    ...
    var hasSensorData: Bool { holdSteadiness > 0 || holdDuration > 0 }
