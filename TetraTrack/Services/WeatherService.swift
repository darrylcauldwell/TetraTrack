...
struct WeatherConditions: Codable, Equatable, Sendable {
    ...
    private enum CodingKeys: String, CodingKey {
        case timestamp, temperature, feelsLike, humidity
        case windSpeed, windDirection, windGust
        case condition, conditionSymbol
        case uvIndex, visibility, pressure
        case precipitationChance, isDaylight
    }
    ...
    nonisolated init(from decoder: Decoder) throws {
        ...
        self.conditionSymbol = try container.decode(String.self, forKey: .conditionSymbol)
        ...
        self.precipitationChance = try container.decode(Double.self, forKey: .precipitationChance)
    ...
    nonisolated func encode(to encoder: Encoder) throws {
        ...
        try container.encode(isDaylight, forKey: .isDaylight)
    }
