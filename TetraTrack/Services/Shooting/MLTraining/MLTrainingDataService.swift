...
final class MLTrainingDataService {
    ...
    private let logger = Logger(subsystem: "dev.dreamfold.tetratrack", category: "MLTraining")
    ...
    /// Clear all training data (images, captures, and manifest)
    func clearAllData() async throws {
        logger.info("Clearing all ML training data")
        ...
        // Reset cached manifest
        manifest = nil

        // Recreate directories
        setupDirectories()

        logger.info("ML training data cleared successfully")
    }
