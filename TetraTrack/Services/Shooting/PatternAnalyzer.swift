...
struct PatternAnalysis: Codable, Equatable, Sendable {
    ...
    static nonisolated let currentAlgorithmVersion = 1

    private enum CodingKeys: String, CodingKey {
        case mpi, standardDeviation, extremeSpread
        case cep50, cep90, directionalBias
        case shotCount, analyzedAt, algorithmVersion
    }
    ...
    nonisolated init(from decoder: Decoder) throws {
        ...
        self.mpi = try container.decode(NormalizedTargetPosition.self, forKey: .mpi)
        self.standardDeviation = try container.decode(Double.self, forKey: .standardDeviation)
        self.extremeSpread = try container.decode(Double.self, forKey: .extremeSpread)
        self.cep50 = try container.decode(Double.self, forKey: .cep50)
        self.cep90 = try container.decode(Double.self, forKey: .cep90)
        self.directionalBias = try container.decode(DirectionalBias.self, forKey: .directionalBias)
        self.shotCount = try container.decode(Int.self, forKey: .shotCount)
        self.analyzedAt = try container.decode(Date.self, forKey: .analyzedAt)
        self.algorithmVersion = try container.decode(Int.self, forKey: .algorithmVersion)
    }

    nonisolated func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: CodingKeys.self)
        try container.encode(mpi, forKey: .mpi)
        try container.encode(standardDeviation, forKey: .standardDeviation)
        try container.encode(extremeSpread, forKey: .extremeSpread)
        try container.encode(cep50, forKey: .cep50)
        try container.encode(cep90, forKey: .cep90)
        try container.encode(directionalBias, forKey: .directionalBias)
