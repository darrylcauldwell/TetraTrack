...
struct ImageQualityAssessment {
    ...
    nonisolated var isAcceptableForDetection: Bool {
...
struct LocalBackground {
    ...
    nonisolated func isDarkEnough(_ candidateIntensity: Double, sigmaThreshold: Double = 2.0) -> Bool {
    ...
    nonisolated func zScore(for intensity: Double) -> Double {
