...
enum ShootingSessionType: String, Codable, CaseIterable {
    ...
    var displayName: String {
        ...
        case .competitionTraining: return "Competition Training"
        case .tetrathlonPractice: return "Tetrathlon Format"
    ...
    var pressureLevel: Int {
        ...
        case .tetrathlonPractice: return 2
        case .competition: return 3
        }
    }

    /// Convert from ShootingSessionContext
    static func from(context: ShootingSessionContext, isTetrathlonFormat: Bool = false) -> ShootingSessionType {
        switch context {
        case .freePractice:
            return .freePractice
        case .competitionTraining:
            return isTetrathlonFormat ? .tetrathlonPractice : .competitionTraining
        case .competition:
            return .competition
        }
    }
