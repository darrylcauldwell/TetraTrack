...
final class GPXExporter {
    ...
    func export(ride: Ride) -> String {
        ...
        <gpx version="1.1" creator="TetraTrack"
    ...
    func exportMultiple(rides: [Ride]) -> String {
        ...
        <gpx version="1.1" creator="TetraTrack"
             ...
             xsi:schemaLocation="http://www.topografix.com/GPX/1/1 http://www.topografix.com/GPX/1/1/gpx.xsd">
          <metadata>
            <name>TetraTrack Export - \(rides.count) rides</name>
    ...
    func exportDateRange(
        ...
        let fileName = "TetraTrack_\(startString)_to_\(endString).gpx"
    ...
    func exportForHorse(_ horse: Horse, rides: [Ride]) -> URL? {
        ...
        let fileName = "TetraTrack_\(sanitizedName)_all_rides.gpx"
