...
struct RideStatistics: GaitTimeTracking {
    ...
    // Turn counts (no longer populated - leftTurns/rightTurns removed from Ride model)
    ...
    // Turn balance (no longer populated - returns 50% since turn counts removed from Ride model)
