...
enum CompetitionActivityType {
    static let viewCompetition = "dev.dreamfold.tetratrack.viewCompetition"
    static let upcomingCompetition = "dev.dreamfold.tetratrack.upcomingCompetition"
}
...
final class CompetitionUserActivityService {
    ...
    func indexUpcomingCompetitions(_ competitions: [Competition]) {
        ...
        for competition in upcomingCompetitions {
            ...
            let item = CSSearchableItem(
                ...
                domainIdentifier: "dev.dreamfold.tetratrack.competitions",
    ...
    func removeAllFromIndex() {
        CSSearchableIndex.default().deleteSearchableItems(withDomainIdentifiers: ["dev.dreamfold.tetratrack.competitions"]) { _ in
            // Silently handle removal
        }
    }
}
