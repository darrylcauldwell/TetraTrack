...
struct DrillImpactChartView: View {
    ...
    @State private var selectedMetric: PerformanceMetric = .rhythmConsistency
...
enum PerformanceMetric: CaseIterable {
    ...
    var displayName: String {
        ...
        case .strideFrequency: return "Stride Frequency"
        case .turnBalance: return "Turn Balance"
        }
    }
    ...
    var icon: String {
        ...
        case .strideFrequency: return "waveform.path"
        case .turnBalance: return "arrow.turn.up.left"
        }
    }
    ...
    func value(from ride: Ride) -> Double {
        ...
        case .symmetry:
            return ride.overallSymmetry
        case .strideFrequency:
            return ride.averageStrideFrequency
        case .turnBalance:
            return Double(ride.turnBalancePercent)
        }
    }
}
