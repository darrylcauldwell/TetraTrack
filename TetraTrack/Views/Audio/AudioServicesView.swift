...
struct AudioServiceButton: View {
    ...
    var body: some View {
        ...
        .accessibleButton(
            "Open \(service.name)",
            hint: service.isInstalled ? "Opens \(service.name) app" : "Opens App Store to download \(service.name)"
        )
    }
}
...
struct PlaybackControlsView: View {
    ...
    var body: some View {
        HStack(spacing: 24) {
            ...
            .accessibleButton("Previous track", hint: "Skip to previous track")
            ...
            .accessibleButton(isPlaying ? "Pause" : "Play", hint: isPlaying ? "Pause playback" : "Resume playback")

            Button(action: nextTrack) {
                Image(systemName: "forward.fill")
                    .font(.title3)
            }
            .accessibleButton("Next track", hint: "Skip to next track")
        }
        .foregroundStyle(AppColors.primary)
