...
//  (Rhythm, Relaxation, Connection, Collection)

import SwiftUI

// MARK: - Training Scale Element

/// Measurable elements of the German Training Scale (Skala der Ausbildung)
enum TrainingScaleElement: String, CaseIterable, Identifiable {
    ...
    var isMeasurable: Bool {
        ...
        case .relaxation, .connection, .collection: return false
        }
    }
        ...
        VStack(alignment: .leading, spacing: 16) {
            ...
            if hasRhythmData {
                ...
                VStack(spacing: 8) {
                    ...
                    Text("Rhythm will be measured during your ride")
                        .font(.caption)
                        .foregroundStyle(.tertiary)
            ...
            VStack(alignment: .leading, spacing: 4) {
                ...
                Text("Relaxation, Connection, and Collection require feel and observation. Tap info for guidance.")
                    .font(.caption2)
                    .foregroundStyle(.tertiary)
            }
        }
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 24) {
                    ...
                    VStack(alignment: .leading, spacing: 8) {
                        ...
                        Text("The other elements—Relaxation, Connection, and Collection—require the rider's feel and observation. Use the descriptions above as a guide for self-assessment.")
                            .font(.caption)
                            .foregroundStyle(.tertiary)
                            .padding(.top, 4)
                    }
...
struct TrainingScalePyramid: View {
    ...
    var body: some View {
        GeometryReader { geometry in
            ...
            let rowHeight = height / CGFloat(elements.count)
