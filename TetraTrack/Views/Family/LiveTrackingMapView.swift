        ...
        ZStack {
            ...
            VStack {
                ...
                HStack(spacing: 16) {
                    ...
                    .accessibleButton("Center on rider", hint: "Move map to show rider's current location")
                }
                .padding()
            }
...
struct RiderMarker: View {
    ...
    var body: some View {
        ZStack {
            ...
            // Activity icon (riding or running)
    ...
    var body: some View {
        VStack(spacing: 12) {
            ...
            HStack {
                ...
                .accessibilityLabel(session.isActive ? "Tracking status: Live" : "Tracking status: Inactive")
            }
            ...
            // Current activity (gait or running phase)
            HStack {
                Image(systemName: session.isRunningSession ? "figure.run" : session.gait.icon)
