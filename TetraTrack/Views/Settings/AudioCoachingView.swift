...
struct AudioCoachingView: View {
    @Bindable private var audioCoach = AudioCoachManager.shared
    ...
    private var ridingSection: some View {
        Section {
            ...
            AnnouncementToggle(
                ...
                description: "Real-time feedback on symmetry, rhythm, and balance",
                isOn: $audioCoach.announceRidingBiomechanics
            )
        } header: {
            Label("Riding", systemImage: "figure.equestrian.sports")
        } footer: {
            Text("Example: \"Cantering\" • \"Rhythm inconsistent\" • \"Good symmetry\"")
        }
    }
    ...
    private var runningSection: some View {
        Section {
            ...
            AnnouncementToggle(
                title: "Biomechanics Coaching",
                description: "Real-time feedback on cadence, impact load, and running rhythm",
