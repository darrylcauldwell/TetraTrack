...
struct WatchDiagnosticsSettingsView: View {
    ...
    // WorkoutLifecycleService removed — sessions are Watch-primary (#309)
    ...
    var body: some View {
        List {
            ...
            // Builder Stats, Running Metrics, and Workout State sections removed
            // — WorkoutLifecycleService deleted, all sessions Watch-primary (#309)
