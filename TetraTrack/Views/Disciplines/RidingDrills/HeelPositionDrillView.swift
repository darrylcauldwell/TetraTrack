...
struct HeelPositionDrillView: View {
    ...
    private var instructionsView: some View {
        VStack(spacing: 20) {
            ...
            .accessibilityLabel("Start Heel Position Drill")
            .accessibilityHint("Begins the heel-down balance practice")
    ...
    private var resultsView: some View {
        VStack(spacing: 20) {
            ...
            HStack(spacing: Spacing.lg) {
                ...
                .accessibilityHint("Restart the heel position drill")
    ...
    private func startDrill() {
        ...
        timer = Timer.scheduledTimer(withTimeInterval: 0.1, repeats: true) { [weak motionManager] _ in
            Task { @MainActor in
                ...
                guard let timerStartDate = self.timerStartDate else { return }
                self.elapsedTime = Date().timeIntervalSince(timerStartDate)
