            ...
            competitionListContent
                ...
                .toolbar {
                    ToolbarItem(placement: .topBarTrailing) {
                        ...
                        .accessibilityLabel("Competition statistics")
                        .accessibilityHint("View statistics and trends for your competitions")
                    }
                    ...
                    ToolbarItem(placement: .topBarTrailing) {
                        ...
                        .accessibilityHint("Open filter options for competitions")
                    }
