...
struct AppColors {
    ...
    // MARK: - Shooting Colors

    /// Pressure context: Free Practice (low pressure) - blue tone
    static var shootingFreePractice: Color { primary }

    /// Pressure context: Training (medium pressure) - orange tone
    static var shootingTraining: Color { running }

    /// Pressure context: Competition (high pressure) - purple tone
    static var shootingCompetition: Color { cardPurple }

    /// Scoring ring 10 (bullseye) - gold/yellow
    static var scoringRing10: Color { warning }

    /// Scoring ring 8 - warm red
    static var scoringRing8: Color { error }

    /// Scoring ring 6 - blue
    static var scoringRing6: Color { primary }

    /// Current target's shots - blue tone
    static var shotCurrent: Color { primary }

    /// Historical/previous target shots - gray
    static var shotHistorical: Color { inactive }

    /// Outlier shots - orange
    static var shotOutlier: Color { running }

    /// Selected/tapped shot - orange
    static var shotSelected: Color { running }

    /// Shot hole markers on target image - red
    static var shotHole: Color { error }

    /// Mean Point of Impact marker - gold/yellow
    static var shotMPI: Color { warning }

    /// Grouping tightness: tight - green
    static var groupTight: Color { active }

    /// Grouping tightness: moderate - blue
    static var groupModerate: Color { primary }

    /// Grouping tightness: wide - orange
    static var groupWide: Color { running }

    /// Auto-center indicator - green
    static var autoCenter: Color { active }
