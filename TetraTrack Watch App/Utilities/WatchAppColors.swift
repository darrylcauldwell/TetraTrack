...
// MARK: - Dynamic Type Support for Watch

/// ViewModifier for Dynamic Type-aware font sizing on watchOS.
struct WatchScaledFont: ViewModifier {
...
extension View {
    /// Apply a Dynamic Type-aware custom font size on watchOS.
    func scaledFont(
        size: CGFloat,
        ...
        modifier(WatchScaledFont(size: size, weight: weight, design: design, relativeTo: textStyle))
    }
}
