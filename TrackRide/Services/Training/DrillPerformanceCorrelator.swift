...
struct CorrelationResult: Identifiable {
    ...
    let performanceMetric: String // e.g., "riderStability"
...
final class DrillPerformanceCorrelator {
    ...
    static let ridingDrillToRideMetrics: [RidingDrillType: [String]] = [
        .heelPosition: ["riderStability", "balanceScore"],
        .coreStability: ["riderStability", "balanceScore", "posture"],
        .twoPoint: ["jumpingPosition", "balanceScore"],
        .balanceBoard: ["riderStability", "movementAbsorption"],
