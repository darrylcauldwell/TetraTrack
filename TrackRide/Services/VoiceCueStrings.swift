...
enum VoiceCueKey: String {
    ...
    case lowImpulsion = "low_impulsion"
    case moreForwardEnergy = "more_forward_energy"
    case excellentImpulsion = "excellent_impulsion"
    case maintainEnergy = "maintain_energy"
    case positionUnstable = "position_unstable"
    case sitDeep = "sit_deep"
    case relaxHips = "relax_hips"
    case workOnStability = "work_on_stability"
    ...
    case excellentEngagement = "excellent_engagement"
    case horseDrifting = "horse_drifting"
    case maintainStraightness = "maintain_straightness"
...
struct VoiceCueStrings {
    ...
    private static let englishStrings: [VoiceCueKey: String] = [
        ...
        .lowImpulsion: "Low impulsion",
        .moreForwardEnergy: "Ask for more forward energy from your horse",
        .excellentImpulsion: "Excellent impulsion",
        .maintainEnergy: "Maintain this forward energy",
        .positionUnstable: "Position unstable",
        .sitDeep: "Sit deep",
        .relaxHips: "relax your hips",
        .workOnStability: "Work on your stability. Keep a steady, balanced position",
        ...
        .excellentEngagement: "Excellent engagement. Your horse is working well from behind",
        .horseDrifting: "Horse drifting",
        .maintainStraightness: "Use your legs to maintain straightness",
    ...
    private static let germanStrings: [VoiceCueKey: String] = [
        ...
        .lowImpulsion: "Wenig Schwung",
        .moreForwardEnergy: "Fordere mehr Vorwärtsenergie von deinem Pferd",
        .excellentImpulsion: "Ausgezeichneter Schwung",
        .maintainEnergy: "Halte diese Vorwärtsenergie",
        .positionUnstable: "Position instabil",
        .sitDeep: "Sitz tief",
        .relaxHips: "entspanne deine Hüften",
        .workOnStability: "Arbeite an deiner Stabilität. Halte eine ruhige, ausbalancierte Position",
        ...
        .excellentEngagement: "Ausgezeichnete Versammlung. Dein Pferd arbeitet gut aus der Hinterhand",
        .horseDrifting: "Pferd driftet",
        .maintainStraightness: "Nutze deine Schenkel für die Geraderichtung",
    ...
    private static let frenchStrings: [VoiceCueKey: String] = [
        ...
        .lowImpulsion: "Manque d'impulsion",
        .moreForwardEnergy: "Demande plus d'énergie vers l'avant à ton cheval",
        .excellentImpulsion: "Excellente impulsion",
        .maintainEnergy: "Maintiens cette énergie vers l'avant",
        .positionUnstable: "Position instable",
        .sitDeep: "Assieds-toi profondément",
        .relaxHips: "détends tes hanches",
        .workOnStability: "Travaille ta stabilité. Garde une position stable et équilibrée",
        ...
        .excellentEngagement: "Excellent engagement. Ton cheval travaille bien de l'arrière-main",
        .horseDrifting: "Cheval qui dérive",
        .maintainStraightness: "Utilise tes jambes pour maintenir la rectitude",
