//
//  TrackRideWidget.swift
//  TrackRide
//
//  Main widget bundle entry point for TrackRide iOS widgets
...
//  3. Ensure the @main attribute is on TrackRideWidgetBundle in the extension
//  4. Add App Groups capability to both main app and widget extension
//  5. Use the same app group identifier: "group.MyHorse.TrackRide"
//
